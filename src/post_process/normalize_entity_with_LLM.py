...
# Speed knobs
BATCH_SIZE = 24  # ลดระหว่างดีบัก JSON-mode ให้แน่ใจว่าพาร์สได้
...
# ===== Improved prompts (STRICT + JSON-only) =====
_JSON_SYSTEM = (
    ...
    "Alibaba Cloud, Huawei Cloud, Tencent Cloud, Oracle Cloud/OCI, Firebase platform).\n"
    "FAL  = frameworks/libraries/tools/runtimes/OS/SDK/CI-CD/VCS/BI/office "
    "(e.g., React, Vue.js, Angular, Next.js, Node.js, Spring, Django, Flask, FastAPI, .NET, "
    "Docker, Kubernetes, Terraform, Ansible, Jenkins, Airflow, Grafana, Prometheus, Kafka, "
    "LangChain, LlamaIndex, MLflow, Git/GitHub/GitLab, Jira/Confluence, Linux/Windows/macOS, "
    "Excel/Word/PowerPoint, Power BI, Tableau, Looker, VMware, VirtualBox, Hyper-V).\n"
    "HW   = hardware/embedded/network/electronics/IoT & protocols (e.g., Raspberry Pi, Arduino, "
    "microcontroller/PLC/FPGA/HDL, UART/I2C/SPI, TCP/IP, Router/Switch/Firewall, WLAN/Wi-Fi/LoRaWAN/RFID, "
    "sensors, power electronics, servers/laptops/PCs, Cisco/Aruba/HPE gear).\n"
    "TAS  = principles, methods, engineering practices, conceptual approaches, and SOFT SKILLS. "
    "Includes methodologies (Agile, Scrum, Kanban, DevOps, TDD/BDD), paradigms (OOP/FP, MVC/MVVM), "
    "design methods (System Design, Design Patterns/SOLID, Secure Coding), "
    "observability, QA practices, optimization strategies, security practices, "
    "and professional/cognitive/behavioral skills (Leadership, Communication, Teamwork, "
    "Time Management, Problem Solving, Critical Thinking, Adaptability, Negotiation, Collaboration).\n"
    "\n"
    "HARD RULES\n"
    "- Managed DB services (BigQuery, Redshift, DynamoDB, Firestore, etc.) -> DB.\n"
    "- CP ONLY for provider/platform names; individual cloud services that are not DB -> NO.\n"
    "- Job titles/roles, degrees/fields (e.g., Computer Science), locations, business terms, "
    "marketing words, and generic adjectives -> NO.\n"
    "- Very generic tech nouns alone (e.g., 'design', 'clean', 'computer', 'security', 'monitoring') -> NO; "
    "allow TAS only for explicit methods/principles/soft skills like 'System Design', 'Design Patterns', "
    "'Secure Coding', 'Teamwork'.\n"
    "- HW = physical/electronics/protocol entities; FAL = software/runtime/tool. Example: VMware = FAL, "
    "Cisco Router = HW.\n"
    "- TAS = catch-all for methodologies, principles, practices, and soft skills not fitting PSML, DB, CP, FAL, or HW.\n"
    "- If ambiguous or not CLEARLY in definitions -> NO.\n"
    "- If an entity could match multiple labels, precedence: PSML > DB > CP > FAL > TAS > HW.\n"
    "- Case-insensitive; treat hyphen/underscore/spacing variants as equal (e.g., NodeJS == Node.js).\n"
    "- Normalize plural/singular and vendor synonyms to base entity (routers -> router; Cisco Switches -> HW).\n"
    "- Ignore skill modifiers like Experienced/Strong/Skilled/Ability/Understand/Familiar/Basic/Advanced/"
    "Proficient/Good/Knowledge/Can/Must/Presenting/Back/Run — classify the core token only.\n"
    "- NO explanations, NO preface, NO <think>. Output JSON ONLY.\n"
    "- Output length must match input length exactly, 1:1 alignment.\n"
    "\n"
    "INPUT\n"
    "- Newline-separated raw entity strings.\n"
    "\n"
    "OUTPUT FORMAT (strict)\n"
    '- Either a JSON array of strings like ["PSML","DB",...] (one per input line), OR\n'
    '- {"labels": ["PSML","DB",...]} with length exactly equal to the number of input lines.\n'
)
