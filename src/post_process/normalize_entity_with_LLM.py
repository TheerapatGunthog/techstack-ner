...
_JSON_SYSTEM = (
    ...
    "Excel/Word/PowerPoint, Power BI, Tableau, Looker).\n"
    ...
    "TAS  = soft skills & engineering methods/patterns/processes "
    "(Agile, Scrum, Kanban, DevOps, TDD/BDD, OOP/FP, MVC/MVVM, Design Patterns/SOLID, "
    "System Design, Observability, QA practices, Cost optimization, Security best practices, "
    ...
    "allow TAS only for explicit techniques like 'System Design', 'Design Patterns', 'Secure Coding'.\n"
